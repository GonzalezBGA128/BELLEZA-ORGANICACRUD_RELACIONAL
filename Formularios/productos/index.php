            ...
            <table class="table table-hover">
                <thead class="table-dark">
                    <tr>
                        ...
                        <th scope="col">NO DE EXISTENCIAS</th>
                ...
                <tbody>
                    ...
                    INNER JOIN provedoor ON productos.provedoorId = provedoor.idprovedoor");
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="row"><?php echo $resultado['idprovedoor'] ?></th>
                            <th scope="row"><?php echo $resultado['preciopaquete'] ?></th>
                            <th scope="row"><?php echo $resultado['descripcion'] ?></th>
                            <th scope="row"><?php echo $resultado['preciounidad'] ?></th>
                            <th scope="row"><?php echo $resultado['noexistencias'] ?></th>
                            <th scope="row"><?php echo $resultado['nombreproducto'] ?></th>
                            <th scope="row">
                                <a href="<?php echo base_url; ?>Formularios/productos/actualizar.php?idproducto=<?php echo $resultado['idproducto'] ?>" class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDP/eliminarDatos.php?idproducto=<?php echo $resultado['idproducto'] ?>" class="btn btn-outline-danger">
